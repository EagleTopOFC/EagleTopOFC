...
if (/^cuál es tu última versión$/i.test(m.text) && chat.simi && !chat.isBanned) { 
    conn.reply(m.chat,`✨por el momento eh sido actualizado por mi 💖creador Eagle me encuentro en la versión V2.3 😍 estoy muy feliz ya que estoy más actualizado que nunca 😃`, m)  
}
